        ...
        <div class="
            ...
            <div class="text-white text-center">
                ...
                <marquee class="text-white text-center" width="100%" direction="left" height="50px">
                    Thanks to 𝓥𝓮𝓡𝓸𝓷 𝓝𝓲𝓬𝓪 🌸 (SME), Chirasree Banerjee, Sneha Adhikary, Pranjal Jaiswal, Snehasish Ghosh, (Alumnus -> Aditya Subham & Pranjal Pathak) for contributing your time and resources.
                </marquee>
                <br>
                <div>
                    <div id="wrapper">
