    ...
    <div class="bg-home px-8 w-full">
		...
		md:mt-0 md:rounded-l-none md:w-48
         ">
            ...
            <div class="r5">
                <div class="text-center"><b>RNR Schedule: CPD / RPD / TAT /TAT+3</b></div><br>
                <div class="text-white text-center">
                    <div id="4time"></div>
                </div>
                <br>
                <hr><br>
                <p><b>OD: RNR 2. mark waiting done till the CPD.</b></p><br>
                <p><b>OD: RNR 2. mark waiting done till the RePromise date.</b></p><br>
...
We are sorry to let you know that your order has been delayed due to some unexpected issues faced by the {seller/couriers}.It will now be delivered to you {}.<br>To thank you for your patience, the seller/courier service provider will add shipping charges paid for this order as a Gift Card to your Flipkart account. <br>We hope to serve you soon.
                    We tried to get in touch with you on <var id="cxph1"><var id="phn1"> <b>_Phone Number_</b></var></var>, to discuss the issue about <var id="cxpro2"><var id="pd2"> <b>_Product Name_</b></var>,</var> but couldn't reach you.<br>We'll try calling you again within the next 4 hours. Meanwhile, please let us know if we can reach you on another number and a convenient time between 9 am and 9 pm by replying to this email. We hope to hear from you soon.
                </p>
                <br>
